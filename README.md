...
- The low address coverage can actually be bad luck with the randomly chosen dataset. We have 93M addresses labeled in the Ethereum network, and only 500k were used for this test.
